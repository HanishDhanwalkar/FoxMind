...
class ResearchAgent:
    ...
    def execute_research(self, task: str, max_steps: int = 10, starting_url: str = "https://duckduckgo.com") -> Dict[str, Any]:
        ...
        try:
            print(colored(f"🌐 Navigating to: {starting_url}", "yellow"))
            ...
            print(colored(f"❌ Research failed with error: {str(e)}", "red"))
            return {
                "task": task,
                "completed": False,
                "error": str(e),
...
4. TYPE_SUBMIT - type text into a form and submit
5. SCROLL - scroll "up" or "down"
6. SEARCH - perform a search (will find search box automatically)
7. ANALYZE - extract information from current page text elements
8. COMPLETE - research task is finished
...
{{
    "action": "NAVIGATE|CLICK|TYPE|TYPE_SUBMIT|SCROLL|SEARCH|ANALYZE|COMPLETE",
    ...
    def _execute_action(self, step: int, action: Action, elements: List[str]) -> StepResult:
        ...
        if action.type == ActionType.NAVIGATE:
            ...
            search_performed = self._perform_search(elements, action.value or action.target)
...
Relevant information:"""
    ...
    def _parse_ai_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"action": "analyze", "reasoning": "Could not parse AI response"}
