...
blacklisted_elements = set(["html", "head", "title", "meta", "iframe", "body", "script", "style", "path", "svg", "br", "::marker",])
...
class Crawler:
    ...
    def crawl(self):
        ...
        tree = self.client.send(
            ...
            {"computedStyles": [], "includDOMRects": True, "includePaintOrder": True},
        )
        
        strings = tree["strings"]
        document = tree["document"][0]
        ...
        for index, node_name_index in enumerate(node_names):
            ...
            if node_name in blacklisted_elements:
                continue
